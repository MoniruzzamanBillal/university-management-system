...
const deleteStudentFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const deleteStudent = yield student_model_1.StudentModel.findOneAndUpdate({ id }, { isDeleted: true }, { new: true, session });
        if (!deleteStudent) {
...
const updateStudentFromDb = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = student_model_1.StudentModel.findOneAndUpdate({ id }, modifiedData, {
        new: true,
        runValidators: true,
    });
    return result;
